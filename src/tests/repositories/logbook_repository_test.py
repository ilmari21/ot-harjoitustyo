...
class TestLogbookRepository(unittest.TestCase):
    ...
    def test_flight_creation(self):
        test_flight = Flight("teuvo", "C152", "OH-TKT", "EFHK", "EFTP", "12:00", "13:30")
        ...
        self.assertEqual(test_flight.aircraft_type, created_flight.aircraft_type)
    ...
    def test_find_flights(self):
        ...
        self.assertEqual(flight_search[0].aircraft_type, test_flight.aircraft_type)
        self.assertEqual(flight_search[0].aircraft_reg, test_flight.aircraft_reg)
